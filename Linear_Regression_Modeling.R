...
# Win percentage vs going for it on 4th avg.
fourth_downs |> 
...
fourth_downs |> 
  ...
  geom_line(aes(y = pred_prob), color = "black", linewidth = 2) +
  geom_point(aes(y = went_for_it, color = ifelse(went_for_it == 1, "darkgreen",
                                                 "darkred")), 
             alpha = 0.3) +
